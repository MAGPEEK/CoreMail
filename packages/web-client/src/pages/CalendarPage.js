...
export function CalendarPage() {
    ...
    return (_jsxs("div", { className: "flex flex-1 overflow-hidden", children: [_jsx(CalendarSidebar, { calendars: calendars ?? [], selectedDate: selectedDate, onSelectDate: handleSelectDate }), _jsxs("div", { className: "flex-1 flex flex-col overflow-hidden", children: [_jsx(CalendarToolbar, { view: view, onChangeView: changeView, onNewEvent: () => setNewEvent({
                            summary: '',
                            dtStart: '',
                            dtEnd: '',

...
echo ""
echo "  3. Mit Observability:"
echo "     docker compose -f infra/docker/docker-compose.yml \\"
echo "       --profile observability up -d --build"
echo ""
echo "  4. Vollständig (inkl. POP3 + CalDAV):"
echo "     docker compose -f infra/docker/docker-compose.yml \\"
echo "       --profile full --profile observability up -d --build"
echo ""
echo "  Webmail:    https://\${MAIL_HOSTNAME}/owa/"
echo "  Admin-ECP:  https://\${MAIL_HOSTNAME}/ecp/"
echo "  Grafana:    http://localhost:3001  (Observability-Profil)"
echo ""

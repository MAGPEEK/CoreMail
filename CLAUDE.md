...
**Aktuelle Version**: `5.1.0` (MAPI/HTTP — Named Properties + PIM Detail-Views + Native NSPI)
...
## Aktuelle Version 5.1.0 — Highlights (Named Properties + PIM Detail-Views + Native NSPI)
...
*Letzte Aktualisierung: 2026-05-27 (v5.1.0 — Named Properties + PIM Detail-Views + Native NSPI; v5.0.0 — Production GA; v4.7.0 — Phase 7; v4.6.0 — virtual PIM; v4.5.0 — Push; v4.4.0 — Attachments; v4.3.0 — Schreiben; v4.2.0 — Lesen; v4.1.0 — ROP-Infra; v4.0.0 — Foundation)*

...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:3.17.0` | Alle Node.js-Services + MWA/BCP-Frontends (kein nginx!) |
...
- **Live-Server**: `84.247.191.198` (Contabo VPS, Ubuntu 24.04, 4 Cores, 7.8 GB RAM) — läuft v3.17.0; Deploy: `cd /opt/coremail && docker compose pull coremail && docker compose up -d coremail`
...
*Letzte Aktualisierung: 2026-05-20 (v3.17.0 — Integrierter HTTPS-Reverse-Proxy: tls-proxy.ts, Port 443, Hot-Reload via Redis, BCP Aktivieren-Button)*

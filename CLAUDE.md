...
- **Live-Server**: `84.247.191.198` (Contabo VPS, Ubuntu 24.04, 4 Cores, 7.8 GB RAM) — läuft v3.18.0; Deploy: `cd /opt/coremail && docker compose pull coremail && docker compose up -d coremail`
...
## Aktuelle Version 3.18.0 — Highlights
...
*Letzte Aktualisierung: 2026-05-24 (v3.18.0 — Outlook-Style Inbox Rules; v3.17.50 — Quelltext-Modal im Kontextmenü; v3.17.49 — MWA Quelltext/EML Auth, Junk-Blacklist, Antwort-Indikator; v3.17.48 — SMTP PIPELINING Race Condition Fix)*

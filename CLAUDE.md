...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:1.0.1` | Alle Node.js-Services + OWA/ECP-Frontends (kein nginx!) |
...
docker build -f infra/docker/Dockerfile.app -t magpeek/coremail-app:1.0.1 .
docker push magpeek/coremail-app:1.0.1
...
*Letzte Aktualisierung: 2026-05-14 (v1.0.1 — Bugfix: Prisma OpenSSL 3.x, Redis Synology, Docker Entrypoint)*

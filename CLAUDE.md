...
**Aktuelle Version**: `4.4.0` (MAPI/HTTP Phase 4: Attachments + Move/Delete)
...
## Aktuelle Version 4.4.0 — Highlights (MAPI/HTTP Phase 4)
...
*Letzte Aktualisierung: 2026-05-26 (v4.4.0 — Phase 4 Attachments+Move/Delete; v4.3.0 — Phase 3 Schreiben+Senden; v4.2.0 — Phase 2 Lesen; v4.1.0 — Phase 1 ROP-Infra+Logon+Folder)*

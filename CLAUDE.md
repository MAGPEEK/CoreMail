...
- **Live-Server**: `84.247.191.198` (Contabo VPS, Ubuntu 24.04, 4 Cores, 7.8 GB RAM) — läuft v3.17.49; Deploy: `cd /opt/coremail && docker compose pull coremail && docker compose up -d coremail`
...
## Aktuelle Version 3.17.49 — Highlights
...
*Letzte Aktualisierung: 2026-05-24 (v3.17.49 — MWA Quelltext/EML Auth, Junk-Blacklist, Antwort-Indikator; v3.17.48 — SMTP PIPELINING Race Condition Fix; v3.17.47 — DNS-Einrichtungs-Panel BCP; v3.17.46 — DKIM PKCS#1 Fix)*

...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:3.17.34` | Alle Node.js-Services + MWA/BCP-Frontends (kein nginx!) |
...
- **Live-Server**: `84.247.191.198` (Contabo VPS, Ubuntu 24.04, 4 Cores, 7.8 GB RAM) — läuft v3.17.34; Deploy: `cd /opt/coremail && docker compose pull coremail && docker compose up -d coremail`
...
## Aktuelle Version 3.17.34 — Highlights
...
*Letzte Aktualisierung: 2026-05-22 (v3.17.34 — DNS-Check lokaler Resolver, UI bereinigt; v3.17.33 — Fix: Redis-Kanal CHANNEL_SETTINGS_RELOAD in Startup-Migration; v3.17.32 — Fix: TLS-Cert-Logik, activate-https → SMTP/IMAP/POP3 automatisch, isActiveProtocol, 503-Fix)*

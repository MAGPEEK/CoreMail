...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:3.17.13` | Alle Node.js-Services + MWA/BCP-Frontends (kein nginx!) |
...
- **Live-Server**: `84.247.191.198` (Contabo VPS, Ubuntu 24.04, 4 Cores, 7.8 GB RAM) — läuft v3.17.13; Deploy: `cd /opt/coremail && docker compose pull coremail && docker compose up -d coremail`
...
*Letzte Aktualisierung: 2026-05-21 (v3.17.13 — BCP vollständig übersetzt EN/DE: MailboxesPage, DomainsPage, QueuesPage, DashboardPage, QuarantinePage + ~1288 i18n-Keys)*

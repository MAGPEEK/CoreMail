...
**Aktuelle Version**: `4.7.0` (MAPI/HTTP Phase 7: NSPI Address-Book Fallback)
...
## Aktuelle Version 4.7.0 — Highlights (MAPI/HTTP Phase 7)
...
*Letzte Aktualisierung: 2026-05-27 (v4.7.0 — Phase 7 NSPI Fallback; v4.6.0 — virtual PIM folders; v4.5.0 — Push; v4.4.0 — Attachments; v4.3.0 — Schreiben+Senden; v4.2.0 — Lesen; v4.1.0 — ROP-Infra)*

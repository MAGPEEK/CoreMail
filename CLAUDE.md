...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:3.13.11` | Alle Node.js-Services + MWA/BCP-Frontends (kein nginx!) |
...
- **Live-Server**: `magpeek/coremail-app:3.13.11` deployed auf `84.247.191.198`
...
*Letzte Aktualisierung: 2026-05-20 (v3.13.11 — Automatischer Logout bei Inaktivität, useInactivityLogout-Hook, /admin/settings/public-Endpoint)*

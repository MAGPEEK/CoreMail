...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:1.1.7` | Alle Node.js-Services + OWA/ECP-Frontends (kein nginx!) |
...
docker build -f infra/docker/Dockerfile.app -t magpeek/coremail-app:1.1.7 .
docker push magpeek/coremail-app:1.1.7
...
*Letzte Aktualisierung: 2026-05-14 (v1.1.7 — Bugfix: OWA/ECP Vite base path)*

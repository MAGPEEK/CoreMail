...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:1.7.19` | Alle Node.js-Services + OWA/ECP-Frontends (kein nginx!) |
...
*Letzte Aktualisierung: 2026-05-16 (v1.7.19 — Quarantine Detail-View & Compliance Info)

...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:3.13.10` | Alle Node.js-Services + MWA/BCP-Frontends (kein nginx!) |
...
- **Live-Server**: `magpeek/coremail-app:3.13.10` deployed auf `84.247.191.198`
...
*Letzte Aktualisierung: 2026-05-20 (v3.13.10 — Bugfix: Retention-Vorlagen-Picker, retentionDays-Validierung auf 0 erlaubt)*

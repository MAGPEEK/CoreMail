...
**Aktuelle Version**: `4.3.0` (MAPI/HTTP Phase 3: Mail-Schreiben + Senden)
...
## Aktuelle Version 4.3.0 — Highlights (MAPI/HTTP Phase 3)
...
*Letzte Aktualisierung: 2026-05-26 (v4.3.0 — MAPI/HTTP Phase 3: Mail-Schreiben+Senden; v4.2.0 — Phase 2: Mail-Lesen; v4.1.0 — Phase 1 ROP-Infra+Logon+Folder)*

...
**Aktuelle Version**: `4.6.0` (MAPI/HTTP Phase 6: Calendar/Contacts/Tasks/Notes virtual folders)
...
## Aktuelle Version 4.6.0 — Highlights (MAPI/HTTP Phase 6)
...
*Letzte Aktualisierung: 2026-05-27 (v4.6.0 — Phase 6 Calendar/Contacts/Tasks/Notes virtual folders; v4.5.0 — Push; v4.4.0 — Attachments; v4.3.0 — Schreiben+Senden; v4.2.0 — Lesen; v4.1.0 — ROP-Infra)*

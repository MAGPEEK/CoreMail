...
**Aktuelle Version**: `5.0.0` (MAPI/HTTP Production-Hardening + Default-Enabled — Major Release)
...
## Aktuelle Version 5.0.0 — Highlights (MAPI/HTTP Production GA)
...
*Letzte Aktualisierung: 2026-05-27 (v5.0.0 — Production GA + MAPI default-on + 19 Tests; v4.7.0 — NSPI+Search; v4.6.0 — PIM folders; v4.5.0 — Push; v4.4.0 — Attachments; v4.3.0 — Schreiben; v4.2.0 — Lesen; v4.1.0 — ROP-Infra; v4.0.0 — Foundation)*

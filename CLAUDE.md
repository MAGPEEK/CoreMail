...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:3.17.24` | Alle Node.js-Services + MWA/BCP-Frontends (kein nginx!) |
...
- **Live-Server**: `84.247.191.198` (Contabo VPS, Ubuntu 24.04, 4 Cores, 7.8 GB RAM) — läuft v3.17.24; Deploy: `cd /opt/coremail && docker compose pull coremail && docker compose up -d coremail`
...
## Aktuelle Version 3.17.24 — Highlights

**v3.17.24** — Audit-Log-Komplettüberarbeitung: PDF-Export, Statistik-Dashboard
...
**v3.17.24** — Lokale Zustellung: `expandRecipients()` aus inbound nach
...
Login-Routen die diese Funktionen verwenden (alle gleichzeitig gefixt in v3.17.13/v3.17.24):
...
*Letzte Aktualisierung: 2026-05-21 (v3.17.24 — Fix: api-gateway duplicate /auth/login Pepper-Bug behoben — Login funktioniert jetzt durch das Frontend)*

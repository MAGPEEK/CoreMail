...
**Aktuelle Version**: `4.5.0` (MAPI/HTTP Phase 5: Push-Notifications via Redis pub/sub)
...
## Aktuelle Version 4.5.0 — Highlights (MAPI/HTTP Phase 5)
...
*Letzte Aktualisierung: 2026-05-26 (v4.5.0 — Phase 5 Push-Notifications; v4.4.0 — Attachments; v4.3.0 — Schreiben+Senden; v4.2.0 — Lesen; v4.1.0 — ROP-Infra)*

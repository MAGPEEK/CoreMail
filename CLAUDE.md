...
|-----------|-------------|--------|
| `coremail` | `magpeek/coremail-app:1.0.3` | Alle Node.js-Services + OWA/ECP-Frontends (kein nginx!) |
...
docker build -f infra/docker/Dockerfile.app -t magpeek/coremail-app:1.0.3 .
docker push magpeek/coremail-app:1.0.3
...
*Letzte Aktualisierung: 2026-05-14 (v1.0.3 — Bugfix: OWA/ECP Vite base path)*
